...
public class HiloServidor implements Runnable
{
    ...
    {
        /*
         * 1. lee un string sql 2. Clasifica la peticion sql (insert, update o delete) select 3. Si es (insert, update o delete) ejecuto la instrucion y retorno si o no 4. si es un select ejecuto la instrucion y retorno objeto con los datos de la consulta o un null;
         */
